...
<div class="page-wrap">
    ...
    <div class="doc-title">Organisation Complete Details</div>
                ...
                <?php else: ?>
                    <?php foreach ($reports as $report): ?>
                        <tr>
                            ...
                            <td><?php echo showValue($report['page_url']); ?></td>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-sm">
                ...
                <?php if (count($parameters) === 0): ?>
                    <tr><td colspan="5" class="text-center text-muted">No parameters found.</td></tr>
                <?php else: ?>
                    <?php foreach ($parameters as $parameter): ?>
                        <tr>
                            <td><?php echo showValue($parameter['report_type']); ?></td>
                            <td><?php echo showValue($parameter['report_name']); ?></td>
